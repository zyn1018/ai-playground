...
public class DateUtils {
    ...
    public static final String DATEFORMAT_SINGLE_DIGIT_MONTH_DAY = "M月d日";
    ...
    public static String parseStringToAnotherFormat(String time, String originFormat, String targetFormat) {
        SimpleDateFormat originFormatPattern = new SimpleDateFormat(originFormat);
        SimpleDateFormat targetFormatPattern = new SimpleDateFormat(targetFormat);
        Date date;
        String result;
        try {
            date = originFormatPattern.parse(time);
            result = targetFormatPattern.format(date);
        } catch (ParseException e) {
            logger.error("[op:parseStringToAnotherFormat] failed, time = {}, originFormat = {}, targetFormat = {}",
                    time, originFormat, targetFormat);
            return "";
        }
        return result;
    }
